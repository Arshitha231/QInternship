...
// Shaun Iyer is the IT identity in both lists: hr and it are the only two
// roles that can switch view modes, and having one of each is what makes the
// difference between them visible from the picker. He is a real member of
// the IT division seeded by seed_it_division.py -- which is cosmetic, since
// the role is a request header and not a property of the row, but labelling
// a Finance analyst "it" would be a confusing thing to leave behind.
const LOCAL_IDENTITIES: Identity[] = [
  { role: "hr", id: "647a0d15-9025-4bb4-ba05-495dc5d7937b", name: "Naomi Lewis" },
  { role: "it", id: "b9266915-3a18-4b88-b0d1-fd500a97119b", name: "Shaun Iyer" },
...
const PRODUCTION_IDENTITIES: Identity[] = [
  ...
  // Verified live against tempest34.azurewebsites.net -- the IT division is
  // seeded on the deployed database too, with different ids, same people.
  { role: "it", id: "1b96a369-3fe4-4f5c-bb1d-e4a954c5b9be", name: "Shaun Iyer" },
