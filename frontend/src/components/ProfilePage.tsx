...
type EmployeeFormState = {
  ...
  hire_date: string;
  cost_centre: string;
  linkedin_profile: string; // <-- PHASE 4
};
...
const NULLABLE_EMPLOYEE_FIELDS = new Set<keyof EmployeeFormState>([
  "preferred_name", "work_phone", "salary", "salary_currency", "date_of_birth", "cost_centre", "linkedin_profile" // <-- PHASE 4
]);
...
function employeeFormFromDetail(d: PersonDetail): EmployeeFormState {
  return {
    ...
    linkedin_profile: d.linkedin_profile ?? "", // <-- PHASE 4
  };
}
      ...
      {editingEmployee && employeeForm && (
        <section className="card edit-employee-card">
          ...
          <div className="edit-grid">
            ...
            {/* --- PHASE 4: LinkedIn URL Input --- */}
            <EditField label="LinkedIn URL">
              <input
                className="edit-input" type="url" placeholder="https://linkedin.com/in/..."
        ...
        <div className="profile-page-col">
          ...
          <section className="card">
            ...
            <ul className="details">
              ...
              {/* --- PHASE 4: LinkedIn Profile Output --- */}
